#!/usr/bin/env bash
# GRPO (plain, not DAPO) on Qwen3.5-9B SFT v2.7_rf.
# Sibling of _launch_dapov2_9b_v27_rf.sh — same model + data, but plain GRPO
# (main_ppo entry) instead of DAPO (main_dapo). v2 reward stack.
...
export EXPERIMENT_NAME=grpo_mixed_v3_stage2_0_grpoeval_qwen35_9b_v27_rf_${CKPT_NAME}

# v2 reward stack (multi-component with r2-gate)
